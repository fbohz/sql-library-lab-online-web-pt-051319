...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN books ON books.series_id = series.id JOIN characters_books ON characters_books.book_id = books.id JOIN characters ON characters_books.character_id = characters.id WHERE character.species = "
